var CreativeCoding = CreativeCoding || {};

(function () {

    CreativeCoding.Point = function (x, y) {
        this.x = x;
        this.y = y;
    }
    
    CreativeCoding.Rectangle = function (x, y, width, height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    CreativeCoding.Star = function (context, numPoints, boundingRect, fillStyle, strokeStyle) { 
        var self = this;
